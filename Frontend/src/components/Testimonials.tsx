...
const TESTIMONIALS = [
  ...
  {
      quote: 'The Alhambra dining suite seats twelve and commands every dinner conversation before the food is even served. Habib and Sons does not make furniture — they make architecture for the home.',
    name: 'Sana Malik',
